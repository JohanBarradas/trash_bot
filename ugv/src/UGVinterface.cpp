...
* View lidar and transform tree (tf)
...
#define VEL_IN_DEFAULT (2*PI/(60.0))//conversion factor//PI/3.0)
#define VEL_OUT_DEFAULT (60.0/(2*PI))    //10.1307)//14978)
//define VEL_OUT_DEFAULT (15.9155*0.33333333)
//#define VEL_OUT_DEFAULT (8.46092)//131.7/4.1)//32.925)
#define ODOM_DEFAULT (PI/368.5)//(85*4.20))
